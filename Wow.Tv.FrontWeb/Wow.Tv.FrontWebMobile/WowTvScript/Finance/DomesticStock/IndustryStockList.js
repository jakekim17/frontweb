...
$(document).ready(function () {
    ...
    $("#divPaging_industryStock").html(cfGetPagingHtml(totalDataCount, $("#frmList_industryStock > #currentIndex").val(), $("#frmList_industryStock > #pageSize").val(), "DomesticStockIndustryPartDetail.IndustryStockList"));
});