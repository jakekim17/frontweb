...
{
    public class WorldStockController : Controller
    {
        ...
        /// </summary>
        /// <returns></returns>
        public ActionResult USA(string menuTab)
        {
        ...
        //주요업종지수 상세페이지
        public ActionResult USAADRDetailList(UsaIndustryCondition condition, string currentEngPartName2)
        {
            condition.PartName = currentEngPartName2;
            ...
            ViewBag.currentEngPartName2 = currentEngPartName2;
