...
namespace Wow.Tv.FrontWeb.App_Start
{
        ...
        protected override void HandleUnauthorizedRequest(AuthorizationContext filterContext)
        {
            ...
            else
            {
                if (HttpContext.Current.Session["CurrentLoginUser"] == null)
                {
                    ...
                    //filterContext.Result = new RedirectResult(userLoginUrl + "?returnurl=" + filterContext.HttpContext.Server.UrlEncode(filterContext.HttpContext.Request.Url.AbsoluteUri));
