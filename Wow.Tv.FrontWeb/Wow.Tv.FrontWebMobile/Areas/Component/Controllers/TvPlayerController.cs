...
using Wow.Tv.FrontWebMobile.MemberInfoService;
using Wow.Tv.FrontWebMobile.TvPlayerService;

namespace Wow.Tv.FrontWebMobile.Areas.Component.Controllers
{
    public class TvPlayerController : BaseController
    {
        ...
        public ActionResult PlayLiveTv()
        {
            ...
            LiveTvInfoModel liveInfo = new TvPlayerService.TvPlayerServiceClient().LiveTvInfo(/*userNumber, now*/);
