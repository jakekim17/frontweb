...
$(document).ready(function () {
    ...
    $("#divPaging_enrollmentDowJones").html(cfGetPagingHtml(totalDataCount_enrollmentDowJones, $("#frmList_enrollmentDowJones > #currentIndex").val(), $("#frmList_enrollmentDowJones > #pageSize").val(), "WorldStockDowJones.SiseEnrollmentDowJonesList"));
});
