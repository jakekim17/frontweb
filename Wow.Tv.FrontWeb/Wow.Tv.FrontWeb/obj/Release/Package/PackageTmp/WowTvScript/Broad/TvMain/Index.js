...
var TvMainIndex = {
    ...
    OpenTvProgramBuy: function () {
        var popOption = "width=665, height=700, resizable=no, scrollbars=yes, status=no;";
    ...
    OpenUseMethod: function () {
        window.open("https://help.wowtv.co.kr/UsageGuide/UsageGuide/PaymentInfo?menuSeq=503", "_blank");
    ...
    aaa: function () {
        ...
        $('.broad-tv-slider ul').bxSlider2({
            ...
            onSliderLoad: function () { // onSliderLoad  onSlideAfter
                //alert("A");
                setTimeout(TvMainIndex.ccc, 500);
            }
        });
...
$(document).ready(function () {
    ...
    $(".time-bar > div > div").on('click', function (e) {
        ...
        TvMainIndex.MoveTime(num);
    });


    setTimeout(TvMainIndex.aaa, 500);
    //setTimeout(TvMainIndex.ccc, 500);


    //TvMainIndex.BindBroadWatch();
    TvMainIndex.BindPopularityNews();
    TvMainIndex.BindStock();
    TvMainIndex.BindMarket();
    TvMainIndex.BindWebDrama();
    TvMainIndex.BindBroadLive();
    TvMainIndex.BindProgramList();
    TvMainIndex.BindNotice();

    setTimeout(function () {
        if ($("#hidIsSnsScroll").val() == "1") {
            var offset = $("#divBroadLive").offset();
