...
$(document).ready(function () {
    ...
    $("#stockPredictionChartTab div span a").on("click", function () {
        $(this).parent('span').parent('div').addClass('on').siblings().removeClass('on');
    });
    ...
    if (arjCode != "undefined") {
        ...
        DomesticStockDetailTotalInfo.GetHpChart('7551', arjCode, '334', '357');
    }
