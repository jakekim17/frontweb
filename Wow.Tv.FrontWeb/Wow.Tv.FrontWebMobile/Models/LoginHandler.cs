...
namespace Wow.Tv.FrontWebMobile
{
    public class LoginHandler
    {
        ...
        {
            //LoginUserInfo sessionUserInfo = new LoginUserInfo();
            //sessionUserInfo.UserId = userInfo.UserId;
            //sessionUserInfo.UserNumber = userInfo.UserNumber;
            //sessionUserInfo.UserName = userInfo.UserName;
            //sessionUserInfo.NickName = userInfo.NickName;
            //sessionUserInfo.LoginDate = userInfo.LoginDate;
            //sessionUserInfo.Ip = userInfo.Ip;
        ...
        public static void DisposeCurrentLoginUser()
        {
            ...
            HttpContext.Current.Session["CurrentEasyLoginUser"] = null;
        }
