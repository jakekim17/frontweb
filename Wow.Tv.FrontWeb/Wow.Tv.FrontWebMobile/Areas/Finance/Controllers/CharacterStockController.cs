...
using Wow.Tv.FrontWebMobile.CharacterStockService;
...
{
    public class CharacterStockController : Controller
    {
        ...
        public ActionResult Detail(NewsCenterCondition condition, string articleId)
        {
            ...
            //기사 상세 내용
            var model = new NewsCenterServiceClient().GetNewsReadInfo(articleId, prevArticleId, "MWEB");
