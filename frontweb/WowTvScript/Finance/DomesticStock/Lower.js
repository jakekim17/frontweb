var DomesticStockLower = {
    PageInit: function (defaultRadioTrue, fixedDisplay, radioElements) {
        ...
        $(".lowerTbl colgroup col").each(function (index, elem) {
        ...
        $(".lowerTbl tr th").each(function (index, elem) {
            //alert($(elem).attr("class"));
            //alert($.inArray($(elem).attr("class"), defaultRadioTrue));
            if ($.inArray($(elem).attr("class"), fixedDisplay) == -1) {
                $(elem).hide();
        ...
        $(".lowerTbl tr td").each(function (index, elem) {
            //alert($(elem).attr("class"));
            //alert($.inArray($(elem).attr("class"), defaultRadioTrue));
            if ($.inArray($(elem).attr("class"), fixedDisplay) == -1) {
                $(elem).hide();
...
$(document).ready(function () {
    ...
    DomesticStockLower.PageInit(defaultRadioTrue, fixedDisplay, radioElements);
    ...
    radioElements.click(function () {
        ...
        $(this).each(function (index, elem) {
            if ($(elem).prop("checked") == true) {
                //checkedCount += 1;
                var checkBool = DomesticStockLower.CheckedRadioCount(elem, checkedCount);
            }
            else {
                //var showClass = "." + $(elem).attr("id");
                //$(showClass).hide();
