...
$(document).ready(function () {
    ...
    $("#divPaging_enrollmentSANDP500").html(cfGetPagingHtml(totalDataCount_enrollmentSANDP500, $("#frmList_enrollmentSANDP500 > #currentIndex").val(), $("#frmList_enrollmentSANDP500 > #pageSize").val(), "WorldStockSANDP500.SiseEnrollmentSANDP500List"));
});
