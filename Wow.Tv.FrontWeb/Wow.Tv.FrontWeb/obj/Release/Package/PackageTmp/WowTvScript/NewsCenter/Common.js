...
var NewsCommon = {
    ...
    GoNewsStockList: function () {
        ...
        var sUrl = String.format("/NewsCenter/News/NewsList?menuSeq={0}&subMenu=stock", menuSeq);
        location.href = sUrl;
    },
    ...
    GoNewsEconomyList: function () {
        ...
        var sUrl = String.format("/NewsCenter/News/NewsList?menuSeq={0}&subMenu=economy", menuSeq);
        location.href = sUrl;
    },
    ...
    GoNewsIndustryList: function () {
        ...
        var sUrl = String.format("/NewsCenter/News/NewsList?menuSeq={0}&subMenu=industry", menuSeq);
        location.href = sUrl;
    },
    ...
    GoNewsLifeList: function () {
        ...
        var sUrl = String.format("/NewsCenter/News/NewsList?menuSeq={0}&subMenu=life", menuSeq);
        location.href = sUrl;
    },
    ...
    GoNewsJobList: function () {
        ...
        var sUrl = String.format("/NewsCenter/News/NewsList?menuSeq={0}&subMenu=job", menuSeq);
        location.href = sUrl;
    },
    ...
    GoCardNewsHome: function () {
        ...
        var sUrl = String.format("/NewsCenter/News/NewsList?menuSeq={0}&subMenu=card", menuSeq);
        location.href = sUrl;
    },
    ...
    GoNewsHome: function () {
        ...
        if (subMenu == "entstar" || subMenu == "sports") {
            ...
            sUrl = String.format("/NewsCenter/EntSpo/Main?menuSeq={0}", MENU_SEQ_DEFINE.ENTSPO.MAIN);
        }
        //포토.영상
        else if (subMenu == "photo" || subMenu == "vod") {

            sUrl = String.format("/NewsCenter/Photo/Main?menuSeq={0}", MENU_SEQ_DEFINE.PHOTO.MAIN);
        }
    ...
    GoOpinionHome: function () {
        ...
        var sUrl = String.format("/Opinion/SerialColumn/ColumnList?menuSeq={0}&subMenu={1}&Class={2}", menuSeq, subMenu, Class);
    ...
    GoPhotoHome: function () {
        ...
        var sUrl = String.format("/NewsCenter/Photo/Main?menuSeq={0}", menuSeq);
        location.href = sUrl;
    },
    ...
    GoManySeeHome: function () {
        ...
        var sUrl = String.format("/NewsCenter/News/ManySee?menuSeq={0}", menuSeq);
        location.href = sUrl;
    },
    /**
     * @description 기자 홈으로..
    ...
    GoReporterHome: function () {
        ...
        var sUrl = String.format("/NewsCenter/Reporter?menuSeq={0}", menuSeq);
        location.href = sUrl;
    },
    /**
     * @description 해시태그 링크
    ...
    GoCafe: function (nickName) {
        ...
        switch (NickValue) {
            ...
            default:
                ...
                //var nickname = encodeURI(NickValue);
                var nickname = NickValue;
                CafeLinkUrl = "http://www.wownet.co.kr/common/profileLink.asp?nickname=" + nickname + "&link=cafe";
                break;
        }
...
function NewsFacebookShare(articleId) {
    ...
    var sUrl = "http://news.wowtv.co.kr/NewsCenter/News/Read?articleId="+ articleId;
